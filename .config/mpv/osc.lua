...
local user_opts = {
    ...
    remaining_playtime = true,            -- display the remaining time in wallclock time it takes to finish
...
function osc_init()
    ...
    ne.content = function ()
        if (state.rightTC_trem) then
            ...
            local property = user_opts.remaining_playtime and "playtime-remaining" or "time-remaining"
